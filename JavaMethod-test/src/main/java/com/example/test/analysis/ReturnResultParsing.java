...
public class ReturnResultParsing {
    public static String HUAWEI = "!Software Version V200R021C10SPC600\n" +
            "#\n" +
    ...
    public static void main(String[] args) {
        ...
        List<String> huawei = getIPCIDR(HUAWEI);
        List<String> sike = getIPCIDR(SIKE);
        List<String> ruijie = getIPCIDR(RUIJIE);
        List<String> h3c = getIPCIDR(H3C);
